export function GoogleIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path fill="#34A853" d="M24 48c6.48 0 11.91-2.14 15.89-5.82l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.97 6.19C6.51 42.62 14.62 48 24 48z"/>
    </svg>
  )
}
...
export function TelegramIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 240 240" aria-hidden="true">
      ...
      <path fill="#fff" d="M54 122l117-46c5-2 10 1 8 9l-20 95c-1 6-5 8-10 5l-29-21-14 13c-2 2-4 3-6 3l2-31 56-51c2-2-1-3-3-1l-69 43-30-9c-6-2-6-7 1-9z" />
    </svg>
  )
}
