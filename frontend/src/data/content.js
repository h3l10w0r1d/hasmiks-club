...
const t = {
  ...
  story: {
    ...
    p4En: `Each of us has her own story, experience, and voice. When women come together, understand and support one another, life becomes warmer. Beautiful days are still ahead. Let us live them together.`,
    p4Hy: `Մեզանից յուրաքանչյուրն ունի իր պատմությունը, փորձը և ասելիքը։ Երբ կանայք միավորվում են, հասկանում ու աջակցում իրար, կյանքը դառնում է ավելի ջերմ։ Գեղեցիկ օրերը դեռ շատ են։ Եկեք դրանք միասին ապրենք։`,
