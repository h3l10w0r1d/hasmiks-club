...
const copy = {
  en: {
    ...
    intro: "Welcome to Hasmik's Club. These Terms & Conditions govern your membership and use of our club, website, events, and services. By joining or using Hasmik's Club, you agree to these terms.",
    sections: [
      { h: '1. Membership & Eligibility', p: ["Hasmik's Club is a private club for women. Membership is personal to you and may not be shared or transferred. We may review applications and reserve the right to accept or decline membership at our discretion."] },
      ...
      { h: '5. Member Conduct', p: ["We are a club built on warmth, respect, and trust. You agree not to harass, harm, or discriminate against other members, and not to use the club or its channels for spam, advertising, or unlawful purposes. We may suspend or remove members who violate these standards."] },
      ...
      { h: '7. Privacy', p: ["We collect and use your personal information only to operate the club, process payments, and communicate with you. We do not sell your personal data. By joining, you consent to receive membership-related communications from us."] },
  ...
  hy: {
    ...
    intro: "Բարի գալուստ Hasmik's Club։ Սույն պայմաններն ու դրույթները կարգավորում են ձեր անդամակցությունը և մեր ակումբից, կայքից, միջոցառումներից ու ծառայություններից օգտվելը։ Միանալով կամ օգտվելով Hasmik's Club-ից՝ դուք համաձայնում եք այս պայմաններին։",
    sections: [
      { h: '1. Անդամակցություն և իրավասություն', p: ["Hasmik's Club-ը կանանց փակ ակումբ է։ Անդամակցությունը անձնական է և չի կարող փոխանցվել կամ կիսվել ուրիշների հետ։ Մենք կարող ենք դիտարկել դիմումները և իրավունք ենք վերապահում մեր հայեցողությամբ ընդունել կամ մերժել անդամակցությունը։"] },
      ...
      { h: '5. Անդամի վարքագիծ', p: ["Մեր ակումբը կառուցված է ջերմության, հարգանքի և վստահության վրա։ Դուք համաձայնում եք չհետապնդել, չվնասել կամ չխտրականացնել մյուս անդամներին, և ակումբը կամ նրա ալիքները չօգտագործել սպամի, գովազդի կամ անօրինական նպատակների համար։ Մենք կարող ենք կասեցնել կամ հեռացնել այս չափանիշները խախտող անդամներին։"] },
      ...
      { h: '7. Գաղտնիություն', p: ["Մենք հավաքում և օգտագործում ենք ձեր անձնական տվյալները միայն ակումբը կառավարելու, վճարումները մշակելու և ձեզ հետ կապ պահպանելու համար։ Մենք չենք վաճառում ձեր անձնական տվյալները։ Միանալով՝ դուք համաձայնում եք ստանալ անդամակցության հետ կապված հաղորդագրություններ մեզանից։"] },
